...
export default function Skills({ skillsObject, editing }) {
                    ...
                    <div className="skillLeftShell">
                        ...
                        <div className="skillsuiteShell">
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[0].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[1].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[2].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[4].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[3].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((30 - int + (skillsuites[5].rank * 5)) * (1 - (skilladept * .10)))}</p>
                            ...
                            <div className="skillRow">
                                ...
                                <p className="skillcost">{Math.floor((40 - int + (skillsuites[6].rank * 5)) * (1 - (skilladept * .10)))}</p>
    ...
    if (skillsuites) {
        ...
        weirdcraft = (<div className="skillRow">
            <p>Weirdcraft</p>
            <p className="skillcost">{Math.floor((40 + (skillsuites[6].rank * 5)) * (1 - (skilladept * .10)))}</p>
