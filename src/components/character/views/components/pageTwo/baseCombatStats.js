                ...
                <div className='combatSkills'>
                    ...
                    <div className="combatShell combatRow">
                        ...
                        <div className="skillRow">
                            ...
                            <p className="skillcost">{Math.floor((40 - int + (combatskillsuites[0].rank * 5)) * (1 - (martialadept * .10)))}</p>
                        ...
                        <div className="skillRow">
                            ...
                            <p className="skillcost">{Math.floor((40 - int + (combatskillsuites[1].rank * 5)) * (1 - (martialadept * .10)))}</p>
                        ...
                        <div className="skillRow">
                            ...
                            <p className="skillcost">{Math.floor((40 - int + (combatskillsuites[2].rank * 5)) * (1 - (martialadept * .10)))}</p>
                        ...
                        <div className="skillRow">
                            ...
                            <p className="skillcost">{Math.floor((40 - int + (combatskillsuites[3].rank * 5)) * (1 - (martialadept * .10)))}</p>
                        ...
                        <div className="skillRow">
                            ...
                            <p className="skillcost">{Math.floor((40 - int + (combatskillsuites[4].rank * 5)) * (1 - (martialadept * .10)))}</p>
